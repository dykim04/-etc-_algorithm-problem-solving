...
int main(void)
{
	...
	*(buff1 + 0) = create_string("I love you");
	*(buff1 + 1) = create_string("and if it's alright");
	*(buff1 + 2) = create_string("I would like to kiss you");
    *(buff1 + 3) = create_string("baby");
	*(buff1 + 4) = create_string("'' ");
	*(buff1 + 5) = NULL;
